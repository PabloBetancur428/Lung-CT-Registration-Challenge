...
| :--: | 
| *Example of images overlaid with their corresponding landmarks. The left image shows the exhale phase, while the right image shows the inhale phase.* |

**The proposed pipeline ranked third among 20 groups and achieved a mean TRE of 1.17 mm on the test dataset during the challenge day.**
